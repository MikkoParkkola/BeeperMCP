...
const search_messages: JSONSchema7 = {
  ...
  properties: {
    ...
    lang: { type: "string" },
    types: { type: "array", items: { enum: ["text", "audio", "image", "video"] } }
  },
  required: ["query"]
};
...
const stats_activity: JSONSchema7 = {
  ...
  properties: {
    target: {
      oneOf: [
        { type: "object", required: ["room"], properties: { room: { type: "string" } } },
        { type: "object", required: ["participant"], properties: { participant: { type: "string" } } },
